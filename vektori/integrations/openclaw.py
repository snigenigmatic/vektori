...
try:
    from openclaw_sdk.plugins import OpenClawPlugin, hook, OpenClawTool
except ImportError:
    class OpenClawPlugin: pass
    def hook(*args, **kwargs): return lambda f: f
    class OpenClawTool: pass
